/* Name : Hardi Chandra */
/* Student ID : 983722 */
/* Project 4 Bucket Sort Version2 */
// Project4-BucketSortVersion2.cpp : Defines the entry point for the console application.
//
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	printf("/************************************/\n");
	printf("/*  Parallel Version2 (Multi Lock)  */\n");
	printf("/************************************/\n");
